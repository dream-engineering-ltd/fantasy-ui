...
const BIN_PATH = path.resolve(import.meta.dirname, "fantasy")
...
async function downloadBinary(platform, arch) {
  ...
  // fantasy --version=1.0.0
  // version = process.argv[3]
  // "https://raw.github.com/dream-engineering-ltd/fantasy-ui-bin/blob/${version ? 'v1.0.0' : 'main'}/fantasy-darwin-amd64"
...
const spawnBinary = () => {
  ...
  child.on("error", err => {
    console.error("Failed to start FantasyUI:", err)
  })
}
